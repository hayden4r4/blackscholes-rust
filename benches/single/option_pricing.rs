...
fn bench_option_pricing(c: &mut Criterion) {
    ...
    let configurations = [
        ("call_atm_short", OptionType::Call, Moneyness::AtTheMoney, TimeToMaturity::ShortTerm, VolatilityLevel::Medium),
        ("put_atm_short", OptionType::Put, Moneyness::AtTheMoney, TimeToMaturity::ShortTerm, VolatilityLevel::Medium),
        ("call_itm_medium", OptionType::Call, Moneyness::InTheMoney, TimeToMaturity::MediumTerm, VolatilityLevel::Medium),
        ("put_itm_medium", OptionType::Put, Moneyness::InTheMoney, TimeToMaturity::MediumTerm, VolatilityLevel::Medium),
        ("call_otm_long", OptionType::Call, Moneyness::OutOfTheMoney, TimeToMaturity::LongTerm, VolatilityLevel::Medium),
        ("call_atm_short_highvol", OptionType::Call, Moneyness::AtTheMoney, TimeToMaturity::ShortTerm, VolatilityLevel::High),
    ];
    ...
    for (name, option_type, moneyness, maturity, vol_level) in configurations {
        ...
        group.bench_with_input(BenchmarkId::new("calc_price", name), &inputs, |b, inputs: &Inputs| {
            b.iter(|| {
        ...
        group.bench_with_input(BenchmarkId::new("calc_rational_price", name), &inputs, |b, inputs: &Inputs| {
            b.iter(|| {
